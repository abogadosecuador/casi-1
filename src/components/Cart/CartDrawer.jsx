                  ...
                  <>
                    <div className="space-y-4 mb-6">
                      {cartItems.map((item) => (
                        ...
                        >
                          <img
                            src={item.image || `https://images.unsplash.com/photo-${item.id % 10 + 1}000000000000?w=80&h=80&fit=crop&auto=format`}
                            alt={item.name}
                            className="w-16 h-16 object-cover rounded-lg"
                            onError={(e) => {
                              e.target.src = `https://images.unsplash.com/photo-${item.id % 10 + 1}000000000000?w=80&h=80&fit=crop&auto=format`;
                            }}
                          />
